    ...
    render() {
        return (
            <div className="w-full h-screen">
                ...
                <div
                    className="rounded-md absolute bg-white lg:w-1/5 lg:-translate-x-1/2 lg:left-1/2 -translate-y-1/2 top-1/2 w-4/5 left-10">
                    <div className="flex justify-center -mt-10">
                        <img className="border-2 bg-white w-20 h-20 rounded-full" src="/logo.png" alt="Logo" width="50"
                             height="50"/>
                    </div>
                        ...
                        <div className="w-full mb-2">
                            <div className="flex items-center">
                                ...
                                <input type="password" id="password" placeholder="Password [demo]"
                                       className="-mx-6 px-8 w-full border rounded px-3 py-1 text-gray-700"
                                       onKeyDown={e => this.handleInputKeypress(e)}
